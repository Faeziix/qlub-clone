...
- `src/app/[locale]/payment/success/page.tsx` + `_components/PaymentSuccessClient.tsx` — payment success page: checkmark, Toman amount, order number, optional review flow (star ratings, comment, name via `/api/reviews`), Back to menu
