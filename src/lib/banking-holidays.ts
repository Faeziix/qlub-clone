 ...
 *
 * Holiday data: official Iranian public holidays for Jalali years 1403–1406,
 * sourced from the official Iranian calendar published by the Office of the
 * Supreme Leader / government decrees. The list covers فروردین public holidays
 * (Nowruz/Sizdah Be-dar), religious holidays (تاسوعا, عاشورا, عید فطر, etc.),
 * national holidays (انقلاب, ارتش, etc.), and martyrdom/birth anniversaries of
 * Imams. Dates are expressed in Jalali YYYY-MM-DD format.
 *
 * NOTE: Religious holidays (those based on the lunar Hijri calendar) shift by
 * ~10-11 days each Jalali year. The dates below are verified for 1403–1404
 * and must be updated annually. The `jalaliDate` key makes each entry
 * predictable and testable against the getJalaliParts() converter.
 *
...
export const IRANIAN_BANKING_HOLIDAYS: BankingHolidayEntry[] = [
  ...
  { jalaliDate: "1404-11-21", name: "عید فطر" },
  { jalaliDate: "1404-11-22", name: "عید فطر (تعطیل)" },
